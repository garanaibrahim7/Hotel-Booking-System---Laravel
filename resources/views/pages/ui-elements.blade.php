                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            <div class="callout callout-info mt-3">
                                For detailed documentation of Components visit <a
                                    href="https://getbootstrap.com/docs/5.3/components/" target="_blank"
                        ...
                        <div class="col-md-6">
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapseOne" class="accordion-collapse collapse show"
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    shown by default, until the collapse plugin
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapseTwo" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    hidden by default, until the collapse plugin
                                                    adds the appropriate classes that we use to style
                                                    each element. These classes control the overall
                                                    appearance, as well as the showing and hiding via
                                                    CSS transitions. You can modify any of this with
                            ...
                            <div class="card card-danger card-outline mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <hr />
                                    <button type="button" class="btn btn-primary mb-2" disabled>Primary
                                        (disabled)</button>
                                    <button type="button" class="btn btn-secondary mb-2" disabled>Secondary
                                        (disabled)</button>
                                    <button type="button" class="btn btn-success mb-2" disabled>Success
                                        (disabled)</button>
                                    <button type="button" class="btn btn-danger mb-2" disabled>Danger
                                        (disabled)</button>
                                    <button type="button" class="btn btn-warning mb-2" disabled>Warning
                                        (disabled)</button>
                                    ...
                                    <button type="button" class="btn btn-danger"
                                        style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;">Custom
                                        button</button>
                                </div>
                                <!--end::Body-->
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card card-primary card-outline mb-4">
                                ...
                                <div class="card-body">
                                    <div class="progress mb-2" role="progressbar" aria-label="Success example"
                                        ...
                                        <div class="progress-bar bg-success" style="width: 25%; border-radius: 0.375rem;">
                                        </div>
                                    </div>
                                    <div class="progress mb-2" role="progressbar" aria-label="Default striped example"
                                        aria-valuenow="10" aria-valuemin="0" aria-valuemax="100">
                                        <div class="progress-bar" style="width: 10%; border-radius: 0.375rem;">
                                        </div>
                                    </div>
                                    <div class="progress mb-2" role="progressbar" aria-label="Info striped example"
                                        aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">
                                        <div class="progress-bar progress-bar-striped bg-info"
                                            style="width: 50%; border-radius: 0.375rem;">
                                        </div>
                                    </div>
                                    <div class="progress mb-2" role="progressbar" aria-label="Warning striped example"
                                        aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">
                                        <div class="progress-bar progress-bar-striped progress-bar-animated bg-warning"
                                            style="width: 75%; border-radius: 0.375rem;">
                                        </div>
                                    </div>
                                    <div class="progress mb-2" role="progressbar" aria-label="Danger striped example"
                            ...
                            <div class="card card-primary card-outline mb-4">
                                ...
                                <!--begin::Body-->
                                <div class="card-body">
                                    <button type="button" class="btn btn-primary mb-2" data-bs-toggle="toast"
                                        data-bs-target="toastDefault">Show default toast</button>
                                    <hr />
                                    <button type="button" class="btn btn-primary mb-2" data-bs-toggle="toast"
                                        data-bs-target="toastPrimary">Show primary toast</button>
                                    <button type="button" class="btn btn-secondary mb-2" data-bs-toggle="toast"
                                        data-bs-target="toastSecondary">Show secondary toast</button>
                                    <button type="button" class="btn btn-success mb-2" data-bs-toggle="toast"
                                        data-bs-target="toastSuccess">Show success toast</button>
                                    <button type="button" class="btn btn-danger mb-2" data-bs-toggle="toast"
                                        data-bs-target="toastDanger">Show danger toast</button>
                                    <button type="button" class="btn btn-warning mb-2" data-bs-toggle="toast"
                                        data-bs-target="toastWarning">Show warning toast</button>
                                    <button type="button" class="btn btn-info mb-2" data-bs-toggle="toast"
                                        data-bs-target="toastInfo">Show info toast</button>
                                    <button type="button" class="btn btn-light mb-2" data-bs-toggle="toast"
                                        data-bs-target="toastLight">Show light toast</button>
                                    <button type="button" class="btn btn-dark mb-2" data-bs-toggle="toast"
                                        data-bs-target="toastDark">Show dark toast</button>
                                    <div class="toast-container position-fixed bottom-0 end-0 p-3">
                                        <div id="toastDefault" class="toast" role="alert" aria-live="assertive"
                                            aria-atomic="true">
                                        ...
                                        <div id="toastPrimary" class="toast toast-primary" role="alert"
                                        ...
                                        <div id="toastSecondary" class="toast toast-secondary" role="alert"
                                            aria-live="assertive" aria-atomic="true">
                                            <div class="toast-header">
                                                <i class="bi bi-circle me-2"></i>
                                                <strong class="me-auto">Bootstrap</strong>
                                        ...
                                        <div id="toastSuccess" class="toast toast-success" role="alert"
                                            aria-live="assertive" aria-atomic="true">
                                            <div class="toast-header">
                                                <i class="bi bi-circle me-2"></i>
                                                <strong class="me-auto">Bootstrap</strong>
                                        ...
                                        <div id="toastDanger" class="toast toast-danger" role="alert"
                                            aria-live="assertive" aria-atomic="true">
                                            <div class="toast-header">
                                                <i class="bi bi-circle me-2"></i>
                                                <strong class="me-auto">Bootstrap</strong>
                                        ...
                                        <div id="toastWarning" class="toast toast-warning" role="alert"
                                            aria-live="assertive" aria-atomic="true">
                                            <div class="toast-header">
                                                <i class="bi bi-circle me-2"></i>
                                                <strong class="me-auto">Bootstrap</strong>
                                        ...
                                        <div id="toastInfo" class="toast toast-info" role="alert"
                                            aria-live="assertive" aria-atomic="true">
                                            <div class="toast-header">
                                                <i class="bi bi-circle me-2"></i>
                                                <strong class="me-auto">Bootstrap</strong>
                                        ...
                                        <div id="toastLight" class="toast toast-light" role="alert"
                                            aria-live="assertive" aria-atomic="true">
                                            <div class="toast-header">
                                                <i class="bi bi-circle me-2"></i>
                                                <strong class="me-auto">Bootstrap</strong>
                                        ...
                                        <div id="toastDark" class="toast toast-dark" role="alert"
                                            aria-live="assertive" aria-atomic="true">
                                            <div class="toast-header">
                                                <i class="bi bi-circle me-2"></i>
                                                <strong class="me-auto">Bootstrap</strong>
                            ...
                            <div class="card card-primary card-outline mb-4">
                                ...
                                <div class="card-body">
                                    <p class="muted">
                                        Placeholder text to demonstrate some <a href="#" data-bs-toggle="tooltip"
                                            data-bs-title="Default tooltip">inline links</a>
                                        with tooltips. This is now just filler, no killer.
                                        Content placed here just to mimic the presence of <a href="#"
                                            data-bs-toggle="tooltip" data-bs-title="Another tooltip">real text</a>.
                                        And all that just to give you an idea of how tooltips
                                        would look when used in real-world situations. So
                                        hopefully you've now seen how <a href="#" data-bs-toggle="tooltip"
                                            data-bs-title="Another one here too">these tooltips on links</a> can work
                                        in practice, once you use them on <a href="#" data-bs-toggle="tooltip"
