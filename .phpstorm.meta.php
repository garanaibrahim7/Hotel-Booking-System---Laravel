...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Contracts\PaymentProviderInterface' => \App\Services\Payments\StripeProvider::class,
    ...
    override(\config(), map([
            ...
            'cache.prefix' => 'string',
            'cache.checkout.duration' => 'NULL',
            'countries.US.name' => 'string',
            'countries.US.currency' => 'string',
            'countries.US.symbol' => 'string',
            'countries.US.states' => 'array',
            'countries.IN.name' => 'string',
            'countries.IN.currency' => 'string',
            'countries.IN.symbol' => 'string',
            'countries.IN.states' => 'array',
            'countries.PK.name' => 'string',
            'countries.PK.currency' => 'string',
            'countries.PK.symbol' => 'string',
            'countries.PK.states' => 'array',
            'countries.CA.name' => 'string',
            'countries.CA.currency' => 'string',
            'countries.CA.symbol' => 'string',
            'countries.CA.states' => 'array',
            'countries.AU.name' => 'string',
            'countries.AU.currency' => 'string',
            'countries.AU.symbol' => 'string',
            'countries.AU.states' => 'array',
            'countries.GB.name' => 'string',
            'countries.GB.currency' => 'string',
            'countries.GB.symbol' => 'string',
            'countries.GB.states' => 'array',
            'countries.DE.name' => 'string',
            'countries.DE.currency' => 'string',
            'countries.DE.symbol' => 'string',
            'countries.DE.states' => 'array',
            'countries.FR.name' => 'string',
            'countries.FR.currency' => 'string',
            'countries.FR.symbol' => 'string',
            'countries.FR.states' => 'array',
            'countries.CN.name' => 'string',
            'countries.CN.currency' => 'string',
            'countries.CN.symbol' => 'string',
            'countries.CN.states' => 'array',
            'countries.AE.name' => 'string',
            'countries.AE.currency' => 'string',
            'countries.AE.symbol' => 'string',
            'countries.AE.states' => 'array',
            'countries.SA.name' => 'string',
            'countries.SA.currency' => 'string',
            'countries.SA.symbol' => 'string',
            'countries.SA.states' => 'array',
            'countries.TR.name' => 'string',
            'countries.TR.currency' => 'string',
            'countries.TR.symbol' => 'string',
            'countries.TR.states' => 'array',
            'countries.MY.name' => 'string',
            'countries.MY.currency' => 'string',
            'countries.MY.symbol' => 'string',
            'countries.MY.states' => 'array',
            'countries.BD.name' => 'string',
            'countries.BD.currency' => 'string',
            'countries.BD.symbol' => 'string',
            'countries.BD.states' => 'array',
            'countries.ZA.name' => 'string',
            'countries.ZA.currency' => 'string',
            'countries.ZA.symbol' => 'string',
            'countries.ZA.states' => 'array',
            ...
            'filesystems.links./home/x26001/ibrahim/Hotel-Booking-System/public/storage' => 'string',
            ...
            'logging.channels.debug.driver' => 'string',
            'logging.channels.debug.path' => 'string',
            'logging.channels.debug.level' => 'string',
            'logging.channels.queries.driver' => 'string',
            'logging.channels.queries.path' => 'string',
            'logging.channels.queries.level' => 'string',
            'logging.channels.queries.ignore_exceptions' => 'boolean',
            'mail.default' => 'string',
            ...
            'mail.mailers.mailtrap2.transport' => 'string',
            'mail.mailers.mailtrap2.host' => 'string',
            'mail.mailers.mailtrap2.port' => 'string',
            'mail.mailers.mailtrap2.username' => 'string',
            'mail.mailers.mailtrap2.password' => 'string',
            'mail.mailers.mailtrap2.timeout' => 'NULL',
            'mail.mailers.gmail.transport' => 'string',
            'mail.mailers.gmail.host' => 'string',
            'mail.mailers.gmail.port' => 'string',
            'mail.mailers.gmail.username' => 'string',
            'mail.mailers.gmail.password' => 'string',
            'mail.mailers.gmail.timeout' => 'NULL',
            ...
            'menu.client.navbar.Home' => 'string',
            'menu.client.navbar.Explore' => 'string',
            'menu.client.navbar.Hotels' => 'string',
            'menu.client.navbar.Rooms' => 'string',
            'menu.client.navbar.Bookings' => 'string',
            'menu.client.navbar.About Us' => 'string',
            'menu.client.navbar.Contact' => 'string',
            'menu.client.navbar.Stay Summary' => 'string',
            'menu.client.navbar.Login' => 'string',
            'menu.admin.navbar.Hotels' => 'string',
            'menu.admin.navbar.Rooms Categories' => 'string',
            'menu.admin.navbar.Bookings' => 'string',
            'menu.admin.navbar.Discounts' => 'string',
            'menu.admin.sidebar.0.title' => 'string',
            'menu.admin.sidebar.0.icon' => 'string',
            'menu.admin.sidebar.0.fill-icon' => 'string',
            'menu.admin.sidebar.0.link' => 'string',
            'menu.admin.sidebar.1.title' => 'string',
            'menu.admin.sidebar.1.icon' => 'string',
            'menu.admin.sidebar.1.fill-icon' => 'string',
            'menu.admin.sidebar.1.link' => 'string',
            'menu.admin.sidebar.2.title' => 'string',
            'menu.admin.sidebar.2.icon' => 'string',
            'menu.admin.sidebar.2.fill-icon' => 'string',
            'menu.admin.sidebar.2.link.0.title' => 'string',
            'menu.admin.sidebar.2.link.0.icon' => 'string',
            'menu.admin.sidebar.2.link.0.fill-icon' => 'string',
            'menu.admin.sidebar.2.link.0.link' => 'string',
            'menu.admin.sidebar.2.link.1.title' => 'string',
            'menu.admin.sidebar.2.link.1.icon' => 'string',
            'menu.admin.sidebar.2.link.1.fill-icon' => 'string',
            'menu.admin.sidebar.2.link.1.link' => 'string',
            'menu.admin.sidebar.3.title' => 'string',
            'menu.admin.sidebar.3.icon' => 'string',
            'menu.admin.sidebar.3.fill-icon' => 'string',
            'menu.admin.sidebar.3.link.0.title' => 'string',
            'menu.admin.sidebar.3.link.0.icon' => 'string',
            'menu.admin.sidebar.3.link.0.fill-icon' => 'string',
            'menu.admin.sidebar.3.link.0.link' => 'string',
            'menu.admin.sidebar.3.link.1.title' => 'string',
            'menu.admin.sidebar.3.link.1.icon' => 'string',
            'menu.admin.sidebar.3.link.1.fill-icon' => 'string',
            'menu.admin.sidebar.3.link.1.link' => 'string',
            'menu.admin.sidebar.4.title' => 'string',
            'menu.admin.sidebar.4.icon' => 'string',
            'menu.admin.sidebar.4.fill-icon' => 'string',
            'menu.admin.sidebar.4.link.0.title' => 'string',
            'menu.admin.sidebar.4.link.0.icon' => 'string',
            'menu.admin.sidebar.4.link.0.fill-icon' => 'string',
            'menu.admin.sidebar.4.link.0.link' => 'string',
            'menu.admin.sidebar.4.link.1.title' => 'string',
            'menu.admin.sidebar.4.link.1.icon' => 'string',
            'menu.admin.sidebar.4.link.1.fill-icon' => 'string',
            'menu.admin.sidebar.4.link.1.link' => 'string',
            'menu.admin.sidebar.4.link.2.title' => 'string',
            'menu.admin.sidebar.4.link.2.icon' => 'string',
            'menu.admin.sidebar.4.link.2.fill-icon' => 'string',
            'menu.admin.sidebar.4.link.2.link' => 'string',
            'menu.admin.sidebar.5.title' => 'string',
            'menu.admin.sidebar.5.icon' => 'string',
            'menu.admin.sidebar.5.fill-icon' => 'string',
            'menu.admin.sidebar.5.link' => 'string',
            'menu.manager' => 'array',
            'menu.customer' => 'array',
            'menu.guest' => 'array',
            ...
            'services.stripe.webhook' => 'string',
            'services.razorpay.key' => 'string',
            'services.razorpay.secret' => 'string',
            'services.exchange-rate.key' => 'string',
...
'cache.stores.failover.driver','cache.stores.failover.stores','cache.prefix','cache.checkout.duration','countries.US.name',
'countries.US.currency','countries.US.symbol','countries.US.states','countries.IN.name','countries.IN.currency',
'countries.IN.symbol','countries.IN.states','countries.PK.name','countries.PK.currency','countries.PK.symbol',
'countries.PK.states','countries.CA.name','countries.CA.currency','countries.CA.symbol','countries.CA.states',
'countries.AU.name','countries.AU.currency','countries.AU.symbol','countries.AU.states','countries.GB.name',
'countries.GB.currency','countries.GB.symbol','countries.GB.states','countries.DE.name','countries.DE.currency',
'countries.DE.symbol','countries.DE.states','countries.FR.name','countries.FR.currency','countries.FR.symbol',
'countries.FR.states','countries.CN.name','countries.CN.currency','countries.CN.symbol','countries.CN.states',
'countries.AE.name','countries.AE.currency','countries.AE.symbol','countries.AE.states','countries.SA.name',
'countries.SA.currency','countries.SA.symbol','countries.SA.states','countries.TR.name','countries.TR.currency',
'countries.TR.symbol','countries.TR.states','countries.MY.name','countries.MY.currency','countries.MY.symbol',
'countries.MY.states','countries.BD.name','countries.BD.currency','countries.BD.symbol','countries.BD.states',
'countries.ZA.name','countries.ZA.currency','countries.ZA.symbol','countries.ZA.states','database.default',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/x26001/ibrahim/Hotel-Booking-System/public/storage',
...
'logging.channels.errorlog.replace_placeholders','logging.channels.null.driver','logging.channels.null.handler','logging.channels.emergency.path','logging.channels.debug.driver',
'logging.channels.debug.path','logging.channels.debug.level','logging.channels.queries.driver','logging.channels.queries.path','logging.channels.queries.level',
'logging.channels.queries.ignore_exceptions','mail.default','mail.mailers.smtp.transport','mail.mailers.smtp.scheme','mail.mailers.smtp.url',
...
'mail.mailers.mailtrap2.transport','mail.mailers.mailtrap2.host','mail.mailers.mailtrap2.port','mail.mailers.mailtrap2.username','mail.mailers.mailtrap2.password',
'mail.mailers.mailtrap2.timeout','mail.mailers.gmail.transport','mail.mailers.gmail.host','mail.mailers.gmail.port','mail.mailers.gmail.username',
'mail.mailers.gmail.password','mail.mailers.gmail.timeout','mail.from.address','mail.from.name','mail.markdown.theme',
'mail.markdown.paths','mail.markdown.extensions','menu.client.navbar.Home','menu.client.navbar.Explore','menu.client.navbar.Hotels',
'menu.client.navbar.Rooms','menu.client.navbar.Bookings','menu.client.navbar.About Us','menu.client.navbar.Contact','menu.client.navbar.Stay Summary',
'menu.client.navbar.Login','menu.admin.navbar.Hotels','menu.admin.navbar.Rooms Categories','menu.admin.navbar.Bookings','menu.admin.navbar.Discounts',
'menu.admin.sidebar.0.title','menu.admin.sidebar.0.icon','menu.admin.sidebar.0.fill-icon','menu.admin.sidebar.0.link','menu.admin.sidebar.1.title',
'menu.admin.sidebar.1.icon','menu.admin.sidebar.1.fill-icon','menu.admin.sidebar.1.link','menu.admin.sidebar.2.title','menu.admin.sidebar.2.icon',
'menu.admin.sidebar.2.fill-icon','menu.admin.sidebar.2.link.0.title','menu.admin.sidebar.2.link.0.icon','menu.admin.sidebar.2.link.0.fill-icon','menu.admin.sidebar.2.link.0.link',
'menu.admin.sidebar.2.link.1.title','menu.admin.sidebar.2.link.1.icon','menu.admin.sidebar.2.link.1.fill-icon','menu.admin.sidebar.2.link.1.link','menu.admin.sidebar.3.title',
'menu.admin.sidebar.3.icon','menu.admin.sidebar.3.fill-icon','menu.admin.sidebar.3.link.0.title','menu.admin.sidebar.3.link.0.icon','menu.admin.sidebar.3.link.0.fill-icon',
'menu.admin.sidebar.3.link.0.link','menu.admin.sidebar.3.link.1.title','menu.admin.sidebar.3.link.1.icon','menu.admin.sidebar.3.link.1.fill-icon','menu.admin.sidebar.3.link.1.link',
'menu.admin.sidebar.4.title','menu.admin.sidebar.4.icon','menu.admin.sidebar.4.fill-icon','menu.admin.sidebar.4.link.0.title','menu.admin.sidebar.4.link.0.icon',
'menu.admin.sidebar.4.link.0.fill-icon','menu.admin.sidebar.4.link.0.link','menu.admin.sidebar.4.link.1.title','menu.admin.sidebar.4.link.1.icon','menu.admin.sidebar.4.link.1.fill-icon',
'menu.admin.sidebar.4.link.1.link','menu.admin.sidebar.4.link.2.title','menu.admin.sidebar.4.link.2.icon','menu.admin.sidebar.4.link.2.fill-icon','menu.admin.sidebar.4.link.2.link',
'menu.admin.sidebar.5.title','menu.admin.sidebar.5.icon','menu.admin.sidebar.5.fill-icon','menu.admin.sidebar.5.link','menu.manager',
'menu.customer','menu.guest','queue.default','queue.connections.sync.driver','queue.connections.database.driver',
...
'services.ses.region','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.stripe.key','services.stripe.secret',
'services.stripe.webhook','services.razorpay.key','services.razorpay.secret','services.exchange-rate.key','session.driver',
...
'signed','throttle','verified','admin-auth',);
        registerArgumentsSet('routes', 
'debugbar.openhandler','debugbar.cache.delete','debugbar.queries.explain','debugbar.clockwork','debugbar.assets',
'sanctum.csrf-cookie','client.home',
'login','login','register','register','logout',
'test','admin.dashboard','admin.bookings.report','admin.bookings.print','admin.hotels.index',
'admin.hotels.create','admin.hotels.store','admin.hotels.show','admin.hotels.edit','admin.hotels.update',
'admin.hotels.destroy','admin.rooms.index','admin.rooms.create','admin.rooms.store','admin.rooms.show',
'admin.rooms.edit','admin.rooms.update','admin.rooms.destroy','admin.categories.index','admin.categories.create',
...
'admin.bookings.update','admin.bookings.destroy','admin.reviews.index','admin.reviews.create','admin.reviews.store',
'admin.reviews.show','admin.reviews.edit','admin.reviews.update','admin.reviews.destroy','admin.reviews.toggle',
'admin.room.bookings','admin.booking.mark-arrival','admin.booking.mark-leaved','admin.booking.cancel-booking','admin.bookings.book',
'admin.discounts.edit','admin.discounts.toggle','admin.discounts.seasonal.offer','admin.discounts.index','admin.discounts.create',
'admin.discounts.store','admin.discounts.show','admin.discounts.edit','admin.discounts.update','admin.discounts.destroy',
'client.rooms','client.room.explore','client.hotels.explore','client.room.details','client.contact',
'client.aboutus','client.profile','client.profile.update','client.delete-account','client.delete-account',
'client.make-review','client.store-review','client.remove-review','password.request','password.email',
'password.reset','password.update','password.change','booking.stay.add','booking.stay.remove',
'booking.stay.update_dates','booking.stay.summary','booking.all','booking.checkout','booking.checkout.process',
'booking.discount.apply','booking.discount.remove','booking.view','booking.success','booking.cancelPayment',
'booking.cancel','booking.cancel.confirm','booking.print_invoice','booking.download_invoice','booking.payment.process',
'cities','user.book','user.book','user.book.success','user.book.cancelPayment','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'admin.booking.booking-table','admin.booking.detail','admin.booking.list','admin.booking.print','admin.booking.reports',
'admin.categories.add','admin.categories.edit','admin.categories.list','admin.dashboard','admin.discount.add',
'admin.discount.edit','admin.discount.list','admin.discount.usage','admin.hotel.add','admin.hotel.edit',
'admin.hotel.info','admin.hotel.list','admin.partials.booking-stats','admin.partials.bookings-chart','admin.partials.bookings-city-list',
'admin.partials.occupancy-trends','admin.partials.stat-cards','admin.partials.top-reviews','admin.reviews.list','admin.room.add',
'admin.room.bookings','admin.room.edit','admin.room.list','auth.forgot-password','auth.login',
'auth.reset-password','client.aboutus','client.alerts','client.auth.forget-password-form','client.auth.login',
'client.auth.register','client.auth.reset-password-form','client.booking.stay-summary','client.booking.view-booking','client.bookings',
'client.checkout','client.contact','client.delete-acount-confirm','client.home','client.hotelExplore',
'client.hotelRoomsExplore','client.layouts.footer','client.layouts.navbar','client.layouts.reviews','client.layouts.sidebar',
'client.layouts.stats','client.layouts.template','client.partials.roomcards','client.partials.searchForm','client.payment.cancel-booking',
'client.payment.invoice','client.payment.print-invoice','client.payment.success','client.profile','client.reviews.make-review',
'client.room.explore-room','client.roomExplore','components.alert-model','components.booking-cart','emails.bookings.cancellation',
'emails.bookings.confirmed','emails.bookings.upcoming-booking-mail','emails.review.removed','layouts.adminlte','layouts.footer',
'layouts.navbar','layouts.sidebar','notifications::email','pages.create-user','pages.forms-general',
'pages.tables-simple','pages.tables-users','pages.ui-elements','pages.ui-elements-second','pages.ui-elements-third',
'vendor.notifications.email','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
...
'validation.custom.attribute-name.rule-name','footer.message','footer.copyright','footer.rights_reserved','hotel.name',
'hotel.description','hotel.address','hotel.city','hotel.country','hotel.state',
'hotel.pincode','hotel.images','hotel.bookings','hotel.status','hotel.cancellation_charge',
'hotel.amenities','hotel.create_title','hotel.create_button','hotel.list_title','hotel.actions',
'hotel.categories','hotel.back_to_list','hotel.info','hotel.edit','hotel.delete',
'hotel.status_running','hotel.add_hotel','hotel.add_first_hotel','hotel.delete_confirm','hotel.delete_confirm_btn',
'hotel.alert','hotel.close','hotel.empty_msg','hotel.','hotel.placeholders.hotel_name',
'hotel.placeholders.desc_example','hotel.placeholders.addr_example','hotel.placeholders.city_example','hotel.placeholders.pincode_example','hotel.placeholders.select_city',
'hotel.placeholders.select_country','hotel.placeholders.select_country_first','hotel.placeholders.search','header.header','hotel.placeholders.select_state',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'APP_LOGO','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER',
...
'DB_PASSWORD','RAZORPAY_KEY','RAZORPAY_SECRET_KEY','STRIPE_KEY','STRIPE_SECRET_KEY',
'STRIPE_WEBHOOK_SECRET','EXCHANGE_RATE_API','TEMP_LOCATION','SESSION_DRIVER','SESSION_LIFETIME',
...
'REDIS_PASSWORD','REDIS_PORT','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','MAIL_MAILER',
'MAIL_HOST','MAIL_PORT','MAIL_USERNAME','MAIL_PASSWORD','MAIL_USERNAME2',
'MAIL_PASSWORD2','GOOGLE_MAIL_MAILER','GOOGLE_MAIL_HOST','GOOGLE_MAIL_PORT','GOOGLE_MAIL_ENCRYPTION',
'GOOGLE_MAIL_USERNAME','GOOGLE_MAIL_FROM_ADDRESS','GOOGLE_MAIL_FROM_NAME','GOOGLE_MAIL_PASSWORD','AWS_ACCESS_KEY_ID',
