...
return [
    ...
    */
    ...
    'after_or_equal' => ':attribute फ़ील्ड :date के बाद या उसके समान तिथि होनी चाहिए।',
    ...
    'array' => ':attribute फ़ील्ड एक ऐरे (array) होना चाहिए।',
    ...
    'before_or_equal' => ':attribute फ़ील्ड :date से पहले या उसके समान तिथि होनी चाहिए।',
    'between' => [
    ...
    'boolean' => ':attribute फ़ील्ड सही (true) या गलत (false) होना चाहिए।',
    'can' => ':attribute फ़ील्ड में एक अनधिकृत मान है।',
    'confirmed' => ':attribute फ़ील्ड की पुष्टि मेल नहीं खाती है।',
    ...
    'different' => ':attribute फ़ील्ड और :other भिन्न होने चाहिए।',
    'digits' => ':attribute फ़ील्ड :digits अंकों का होना चाहिए।',
    'digits_between' => ':attribute फ़ील्ड :min और :max अंकों के बीच होना चाहिए।',
    'dimensions' => ':attribute फ़ील्ड की छवि के आयाम (dimensions) अमान्य हैं।',
    'distinct' => ':attribute फ़ील्ड में एक डुप्लिकेट मान है।',
    'doesnt_contain' => ':attribute फ़ील्ड में निम्नलिखित में से कोई भी शामिल नहीं होना चाहिए: :values.',
    'doesnt_end_with' => ':attribute फ़ील्ड निम्नलिखित में से किसी एक के साथ समाप्त नहीं होना चाहिए: :values.',
    'doesnt_start_with' => ':attribute फ़ील्ड निम्नलिखित में से किसी एक के साथ शुरू नहीं होना चाहिए: :values.',
    'email' => ':attribute फ़ील्ड एक मान्य ईमेल पता होना चाहिए।',
    'encoding' => ':attribute फ़ील्ड :encoding में एन्कोड होना चाहिए।',
    ...
    'image' => ':attribute फ़ील्ड एक छवि (image) होनी चाहिए।',
    'in' => 'चयनित :attribute अमान्य है।',
    'in_array' => ':attribute फ़ील्ड :other में मौजूद होना चाहिए।',
    'in_array_keys' => ':attribute फ़ील्ड में कम से कम निम्नलिखित कुंजियों (keys) में से एक होनी चाहिए: :values.',
    ...
    'list' => ':attribute फ़ील्ड एक सूची (list) होनी चाहिए।',
    'lowercase' => ':attribute फ़ील्ड लोअरकेस (lowercase) में होना चाहिए।',
    'lt' => [
    ...
    'missing' => ':attribute फ़ील्ड मौजूद नहीं होना चाहिए (गायब होना चाहिए)।',
    'missing_if' => ':attribute फ़ील्ड मौजूद नहीं होना चाहिए जब :other :value हो।',
    'missing_unless' => ':attribute फ़ील्ड मौजूद नहीं होना चाहिए जब तक कि :other :value न हो।',
    'missing_with' => ':attribute फ़ील्ड मौजूद नहीं होना चाहिए जब :values मौजूद हो।',
    'missing_with_all' => ':attribute फ़ील्ड मौजूद नहीं होना चाहिए जब :values मौजूद हों।',
    'multiple_of' => ':attribute फ़ील्ड :value का गुणक (multiple) होना चाहिए।',
    ...
    'password' => [
        ...
        'mixed' => ':attribute फ़ील्ड में कम से कम एक अपरकेस (बड़ा) और एक लोअरकेस (छोटा) अक्षर होना चाहिए।',
    ...
    'starts_with' => ':attribute फ़ील्ड निम्नलिखित में से किसी एक के साथ शुरू होना चाहिए: :values.',
    'string' => ':attribute फ़ील्ड एक स्ट्रिंग होनी चाहिए।',
    'timezone' => ':attribute फ़ील्ड एक मान्य समय क्षेत्र (timezone) होना चाहिए।',
