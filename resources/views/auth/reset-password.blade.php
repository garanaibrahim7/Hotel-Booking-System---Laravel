        ...
        <div class="login-box">
            <div class="login-logo">
                <a href="{{ route('welcome') }}">
                    ...
                    <svg class="w-full text-[#F53003] dark:text-[#F61500] transition-all translate-y-0 opacity-75 max-w-none duration-750 starting:opacity-0 starting:translate-y-6"
                        viewBox="0 0 438 104" fill="none" xmlns="http://www.w3.org/2000/svg" style="width: 100px">
                        <path d="M17.2036 -3H0V102.197H49.5189V86.7187H17.2036V-3Z" fill="currentColor"></path>
                        <path
                        ...
                        <path
                            ...
                            fill="currentColor"></path>
                        <path d="M438 -3H421.694V102.197H438V-3Z" fill="currentColor"></path>
            ...
            @else
                <div class="card">
                    <div class="card-body login-card-body">
                        <p class="login-box-msg p-0">Choose your New Password</p>
                        <p class="login-box-msg px-0">for Your Mail - {{ request()->email }}</p>
